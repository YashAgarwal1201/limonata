...
//                   <h3 className=" font-subheading not-italic">
//                     Use easy mode?{" "}
//                   </h3>
//                 </div>
//                 <span className=" capitalize font-content not-italic">
...
//                 <h3 className=" font-subheading not-italic">View my resume</h3>
//               </div>
//             }
//           >
...
//                 <h3 className="font-subheading not-italic">Clear data</h3>
//               </div>
//             }
//           >
...
//                   </h3>
//                 </div>{" "}
//                 <span className="text-color4 capitalize font-content not-italic">
...
//           headerTemplate={
//             <span
//               className="h-full text-color4 font-subheading font-medium not-italic"
//               onClick={() => {
//                 setShowMenuDialog(false);
